...
unoServer: server_uno.o server_main.o
	g++-10 -Wall -pedantic -g -o unoServer server_uno.o server_main.o -lssl -lcrypto 
...
simpleBot: simple_bot.cpp cards.h
	g++-10 -Wall -pedantic -g -std=c++2a -o simpleBot simple_bot.cpp -lssl -lcrypto
client: client.cpp cards.h
	g++-10 -Wall -pedantic -g -std=c++2a -o client client.cpp -lssl -lcrypto
clean:
